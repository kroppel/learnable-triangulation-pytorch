...
def visualize_batch(images_batch, heatmaps_batch, keypoints_2d_batch, proj_matricies_batch,
    ...
    for view_i in range(n_cols):
        ...
        draw_2d_pose(keypoints_2d_gt_proj, axes[row_i][view_i], kind=kind, line_width=2, point_size=3)
    row_i += 1
    ...
    for view_i in range(n_cols):
        ...
        draw_2d_pose(keypoints_2d_pred_proj, axes[row_i][view_i], kind=pred_kind, line_width=2, point_size=3)
    row_i += 1
